...
export const SLIDES: SlideEntry[] = [
  ...
  { id: '30-transformers',          track: 'transformers', trackIndex: 1, trackTotal: 6 },
  { id: '31-transformer-shift',     track: 'transformers', trackIndex: 2, trackTotal: 6 },
  { id: '32-transformer-ppl',       track: 'transformers', trackIndex: 3, trackTotal: 6 },
  { id: '33-transformer-analytics', track: 'transformers', trackIndex: 4, trackTotal: 6 },
  { id: '34-math-sequence',         track: 'transformers', trackIndex: 5, trackTotal: 6 },
  { id: '35-math-architecture',     track: 'transformers', trackIndex: 6, trackTotal: 6 },
